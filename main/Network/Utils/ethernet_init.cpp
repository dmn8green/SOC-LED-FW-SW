...
#if CONFIG_EXAMPLE_USE_INTERNAL_ETHERNET
    eth_handles = (esp_eth_handle_t *) eth_init_internal(NULL, NULL);
    ESP_GOTO_ON_FALSE(eth_handles, ESP_FAIL, err, TAG, "internal Ethernet init failed");
    eth_cnt++;
#endif //CONFIG_EXAMPLE_USE_INTERNAL_ETHERNET
